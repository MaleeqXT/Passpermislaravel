...
use App\Http\Controllers\V1\Inertia\Admin\ReportsController;
...
Route::middleware(['auth:sanctum,web', 'role:admin|secretary', 'slow'])->group(function () {
...
// Secretary dashboard routes are defined in routes/secretary/web.php
    ...
    Route::prefix('reservations')->name('reservations.')
        ->controller(ReservationAdminController::class)->group(function () {
            ...
            Route::get('/unrestricted', 'unrestrictedIndex')->name('unrestricted.index');
...
// });
    ...
    Route::get('/reports/active-students', [ReportsController::class, 'activeStudents'])->name('reports.activeStudents.index');
    Route::get('/reports/active-students/export', [ReportsController::class, 'exportActiveStudents'])->name('reports.activeStudents.export');
    Route::get('/reports/active-students/{student}/pdf', [ReportsController::class, 'downloadStudentReport'])->name('reports.activeStudents.pdf');
    ...
    Route::prefix('users')->name('users.')->group(function () {
        ...
        // ----- Monitors -----
        // monitor/documents/piece-identities
