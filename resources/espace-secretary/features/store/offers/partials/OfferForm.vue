...
import {routes} from '@espace-secretary/routes.js';
            ...
            <div class="form-content">
                ...
                <Card block padding title="Prix (Criel)">
                    <div class="grid md:grid-cols-2 gap-3">
                     ...
                     <EditorField v-model="form.criel_caracteristiques" label="Caractéristiques (CRIEL)"
                                 :error="form.errors.criel_caracteristiques"/>
