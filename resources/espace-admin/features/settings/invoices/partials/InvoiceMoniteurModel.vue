...
<template>
    <div class="bg-white text-dark rounded-xl px-6 py-28 font-pdf">
        <div class="flex justify-between items-center border-b-4 border-primary pb-5 mb-10">
            <h1 class="text-2xl font-bold mb-4">
                Facture n° <b>{{ invoice?.num_facture }}</b>
            </h1>

            <img src="/assets/logo.svg " class="w-20" alt="Auto école Moniteur Indépendant.fr" />
        </div>
        ...
        <ul class="flex gap-10 p-4 my-10 text-sm">
            ...
            <li class="leading-loose">
                ...
                <p>SIRET : Lorem, ipsum dolor.</p>
                <p>E-mail : contact@AD.com</p>
            </li>
        </ul>
