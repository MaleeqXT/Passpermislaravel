...
import { ChartLineIcon, EditIcon } from '@adersolutions/icons';
...
<template>
    <tr class="group/actions">
        ...
        <td class="cell">
            {{ item.monitor?.details?.departement }}
        </td>
        <td class="cell">
                    ...
                    <Button
                        ...
                        @click="
                            $emit('click:resume-hours', {
                                billing: item.id,
                                moniteur: item.monitor?.id,
                            })
                        "
                    />
                    <Button :icon="EditIcon" tooltip="Modifier" info grouped @click="state.isEdit = true" />
                </template>
                <template v-else>
