...
import { ViewScheduleByMonth, ViewScheduleByWeek, ScheduleHeader, LessonMonitorDialog } from '../reservations/partials';
import ReservationFormDrawer from './partials/dialogs/ReservationFormDrawer.vue';
...
const actions = [
    {
        label: 'Nouvelle réservation (Sans restriction)',
        variant: 'primary',
        icon: null,
        onAction: () => {
            state.selected = {};
