...
class FetchByWeekUnrestrictiveReservationRepo
{
    public static function run(array $attributes)
    {
        return TrainingUnrestricted::query()
            ...
            ->when(
                ...
                fn($query) => $query->whereBetween('date', [now()->startOfWeek(CarbonInterface::MONDAY), now()->endOfWeek(CarbonInterface::SUNDAY)])
            )
